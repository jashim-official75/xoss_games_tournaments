...
@section('content')
                        ...
                        <div class="slider_content">
                            @if (auth()->guard('subscriber')->check())
                              <!--  <h1 class="sm-hide"><a
                                ...
                                <h1 class="sm-hide"><a
                                        href="#">{{ $game->game_name }}</a>
                                </h1>
                            @else
                                <h1 class="sm-hide"><a href="{{ route('user.sign_in') }}">{{ $game->game_name }}</a></h1>
                            @endif
                            <h2 class="sm-hide">Join now for the ultimate gaming clash and win rewards</h2>
                         <!--   @if (auth()->guard('subscriber')->check())
    ...
    <section id="tournament_card" class="section-top">
        <div class="custom_container">
            <div class="title pb-5">
                ...
                <p class="subheading_common"> Participate in the tournament, play the game, and stand a chance to win prizes.</p>
            ...
            <div class="card_full_width mb-0 upcoming_games"
                ...
                <div class="card_content">
                    <div class="game_name">
                        ...
                        <div class="entry_fee">
                            <h3>Entry Fee : ৳{{ $launcing_game->game_fee }}</h3>
                        </div>
    ...
    <section id="tournament_card" class="section-top">
        <div class="custom_container">
            <div class="title pb-5">
                ...
                <p class="subheading_common">Stay connected to participate in the upcoming tournament games.</p>
                <div class="title_bar">
                    <div class="bar"></div>
                    <img src="{{ asset('assets/frontend/img/battle.png') }}" alt="">
                    <div class="bar"></div>
            ...
            @foreach ($games as $game)
                <div class="card_full_width upcoming_games"
                    ...
                    <div class="card_content">
                        <div class="game_name">
                            <div class="game_profile d-md-none d-block">
                                <img src="{{ asset('uploads/Tournamant/GameIcon/' . $game->game_small_icon) }}"
                                    alt="">
                            </div>
    ...
    <section id="tournament_steps" class="section">
        <h1 class="title">Simple 3 Steps Need to Follow Up <br> <span>To Win Prizes!</span> </h1>
        <div class="container">
    ...
    <section id="tournament_card" class="section-top">
        <div class="container-fluid">
            <div class="title pb-5">
                ...
                <p class="subheading_common">Participate in the tournament games and stand a chance to win these prizes.</p>
                <div class="title_bar">
                    <div class="bar"></div>
                    <img src="{{ asset('assets/frontend/img/battle.png') }}" alt="">
                    <div class="bar"></div>
        ...
        <div class="custom_container">
            <div class="socail_media_inner">
                ...
                <div class="socail_icons">
                    <div class="icon">
                        <a href="https://www.facebook.com/xoss.games" style="--i:#4267B2;" previewlistener="true"><i
                                class="fa-brands fa-facebook-f"></i></a>
                    </div>
                    <div class="icon">
                        <a href="https://www.youtube.com/@xossgames" style="--i:#FF0000;" previewlistener="true"><i
                                class="fa-brands fa-youtube"></i></a>
                    </div>
                    <div class="icon">
                        <a href="https://www.linkedin.com/showcase/xoss-games" style="--i:#0072b1;"
                            previewlistener="true"><i class="fa-brands fa-linkedin-in"></i></a>
                    </div>
                    <div class="icon">
                        <a href="https://www.instagram.com/xossgames" style="--i:#c72d8d;" previewlistener="true"><i
                                class="fa-brands fa-instagram"></i></a>
                    </div>
                    <div class="icon">
                        <a href="https://twitter.com/xossgames" style="--i:#1DA1F2;" previewlistener="true"><i
        ...
        <div class="container-fluid">
            <div class="refeer_frinds">
                ...
                <div class="mobile_gift">
                    <img src="{{ asset('assets/frontend/img/reffer_invite_mobile.webp') }}" alt=""
                        width="200px">
                </div>
